...
<body class="bg-base-300 flex flex-col min-h-screen w-full">
    <header >
        <nav class="bg-white flex flex-row justify-between w-full text-black px-5 py-3 border-b-2 border-neutral-500">
            <div class="flex items-center bg-yellow-400 p-1">
                <p class="text-3xl font-bold">WoW</p>
            </div>
            <div class="flex items-center ">
                <p class="text-3xl font-bold">Hogar</p>
            </div>
            <div class="flex items-center bg-black p-1">
                
                <span class="icon-[ph--user-circle-fill] bg-white text-4xl" role="button"></span>
            </div>
        </nav>
    </header>
    <main class="flex flex-row flex-grow relative items-center justify-center bg-neutral-100">
        
        <div class="flex justify-cente p-5 flex-col w-3/5 gap-3 max-h-[40rem]">

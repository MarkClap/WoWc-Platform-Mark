                        ...
                        <section class=" py-1 flex justify-end">
                            ...
                            <dialog id="my_modal_1" class="modal">
                                <div class="modal-box p-8 text-black bg-white border">
                                  <h3 class="font-bold text-2xl justify-center flex w-ful">Introduce el correo del usuario</h3>
                                  <div class="modal-action">
                                    <form method="POST" class="w-full p-3" action="{{ route('teachers.store') }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="email" id="email" class="form-input w-full text-black" placeholder="user@example.com">
                                        </div>
                            ...
                            @foreach ($teachers as $teacher)
                                <tr>
                                    ...
                                    <td class="p-3 px-5 flex justify-start">
                                        <form action="{{ route('teachers.destroy', $teacher->id) }}" method="get" class="flex flex-row justify-center items-center mb-0" >
                                            @csrf
                                            @method('DELETE')

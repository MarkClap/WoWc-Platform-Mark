...
@section('content')
    <div class="bg-white dark:bg-black  w-full flex flex-col items-center overflow-x-scroll mb-18">
            ...
            <div class="p-3 ">
                <div class="overflow-x-auto">
                    <table class="table-auto w-full space-x-3 text-white">
                        ...
                        <tbody class="text-sm divide-y divide-gray-100 text-neutral-600 dark:text-white">
                            <tr>

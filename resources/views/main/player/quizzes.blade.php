...
@section('content')
    <div
        class="bg-white text-black dark:text-white dark:bg-neutral-900 w-full flex justify-center  flex-col gap-2 items-center">
        ...
        <section class=" w-3/6 flex py-2 px-4 flex-col space-y-2 border-2 border-black dark:border-white">
            ...
            <div class=" p-2">
                <p>Lee atentamente las preguntas y selecciona una respuesta, el resultado del examen saldra al terminar de
                    responder</p>
            </div>
        ...
        <section class=" w-3/6 flex py-2 px-4 flex-col space-y-2 border-2 border-black dark:border-white">
            ...
            <div class="p-1 flex justify-between border-b-2 items-center text-xl font-semibold">
                <p>Examen 1</p>
                <form class="btn bg-yellow-500 flex-1" method="get"
                    action=" {{ route('player.quizzes.start', ['token' => $token]) }}">

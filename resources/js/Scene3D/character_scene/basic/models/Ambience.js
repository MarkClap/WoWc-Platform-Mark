...
export async function createAmbience1(scene) {
    ...
    const bg1 = await loadGLTFModel(
        "Scene3D/character_scene/models/Ambience/Ambience1/bg1_optimized.glb",
        scene
    );
    const lake = await loadGLTFModel(
        "Scene3D/character_scene/models/Ambience/Ambience1/lake.glb",
        scene,
        1,
        { x: 5, y: -0.45, z: -2.5 }
    );
...
export async function createAmbience2(scene) {
    ...
    const waterfall = await loadGLTFModel(
        "Scene3D/character_scene/models/Ambience/Ambience2/Waterfall_scene.glb",
        scene,
        2.5
    );
...
export async function createAmbience3(scene) {
    ...
    const desert = await loadGLTFModel(
        "Scene3D/character_scene/models/Ambience/Ambience3/Desert.glb",
        scene,
        0.05
    );
...
export async function createAmbience4(scene) {
    ...
    const forest = await loadGLTFModel(
        "Scene3D/character_scene/models/Ambience/Ambience4/Forest_scene_optimized.glb",
        scene,
        5
    );
...
export async function createAmbience5(scene) {
    ...
    const swamp = await loadGLTFModel(
        "/Scene3D/character_scene/models/Ambience/Ambience5/Swamp Island.glb",
        scene,
        5
    );
